...
#buttons for each row and coloumn alon with fucntions using tkinter
...
#creat clear button to clear screen
btn_clear = tk.Button(root, text="C", command= clear_field, width=11, font=("Arial", 14))
btn_clear.grid(row=6, column=1, columnspan=2)
# creat and link equal button whcih calls the eval functions and show results
